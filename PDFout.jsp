                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class=" dropdown"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Time Sheet<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                               <li><a href="AddAttnd.jsp">Add Attedence</a></li>
                                 <li><a href="AddAttendence.jsp">Add Attedence Sheet</a></li>
                                <li><a href="ManageAttendence.jsp">Manage Attedence</a></li>
                                <li><a href="ListAttendenceServlet">List Attedence</a></li>
                            </ul>
                        </li>
...
<%=request.getAttribute("timesheet") %>
