...
<fieldset style="min-height: 490px;">
		<legend>List Leave Position</legend>
<form class="form-horizontal" role="form" method="get" action="ListLeavePositionServlet" onclick="check(this.form)" onclick="validate(this.form)" >
  <div class="form-group">
  
    <label class="control-label col-sm-2" for="employeeid">Enter Year<span style=color:red>*</span></label>
    <div class="col-sm-6">
...
<table class="table table-bordered table table-striped" border="2">
  ...
  <th><font color='Red'>TOTAL LEAVES</font></th></tr>
  </thead>
...
<% } %>
  ...
  <div style="text-align:center;">
				<button formaction="ListLeavePDFServlet" class="btn btn-danger" ><span class="fa fa-file-pdf-o" ></span> PDF</button>
