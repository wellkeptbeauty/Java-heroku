...
<title>List of Absents</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
   ...
   <script src="resources/javascript/ExtraLeaves.js"></script>
            ...
            <div class="">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class=" down active"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports<span class="caret"></span></a>
                            <ul class="dropdown-menu">
...
<fieldset style="min-height: 490px;">
		<legend>Report on Absents</legend>
<form class="form-horizontal" role="form" method="get" action="AbsenteesServlet" onclick="check(this.form)">
  <div class="form-group">
  
    <label class="control-label col-sm-3" for="employeeid">Month and Year <span style=color:red>*</span></label>
    <div class="col-sm-6">
    
     <input type="month" class="form-control" id="sel2" name="fdate"></div>
    <button type="submit" class="btn btn-info" ><span class="glyphicon glyphicon-search"></span>  SUBMIT</button>
    </div>
  
  <h4 align="left">Month & Year : <%=request.getAttribute("yrs") %></h4>
  ...
  <tr style="background-color:silver";>
		...
		<th><font color='Red'>Date of Absent from</font></th>
		<th><font color='Red'>Date of Absent to</font></th>
      </tr>
    </thead>
    <% for(EmployeePojo exleave1:cList) { %>
  
<tr>
<td><%out.println(exleave1.getEid()); %></td>
<td><%out.println(exleave1.getEname());%></td>
<td><%out.println(exleave1.getTot());%></td>
<td><%out.println(exleave1.getAveg());%></td>
       	</tr><% } %>
    </tbody>
  </table>
   ...
   <div style="text-align:center;">
				...
				<button class="btn btn-danger" formaction="AbsentPDFServlet" ><span class="fa fa-file-pdf-o" ></span> PDF</button>
	</div>
	</div>
	</form>
	</fieldset>
