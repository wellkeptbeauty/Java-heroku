...
<form class="form-horizontal" role="form" name="myForm" method="get" action="AddAttendenceSerlvet" >
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="year">Month & Year</label>
    <div class="col-sm-9"> 
      <input type="month" class="form-control" name="mnth" id="date" required />
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9"> 
      <input type="time" class="form-control" id="tin" name="tin" placeholder="Time In" required />
    </div>
	 </div>
    ...
    <div class="col-sm-9"> 
      <input type="time" class="form-control" id="tout" name="tout" placeholder="Time Out" required />
    </div>
	 </div>
