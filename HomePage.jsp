...
<div class="container" style="min-height:420px">
		<div class="row dash-up">
			...
			<div class="col-md-4">
				<div id="col">
				    <div class="maingrid">Attendence</div>
                       <div class="subgrid">Max-<span class="maxspan"><%=request.getAttribute("hmax") %>%</span></div>
					   <span style="width: 100%;" class="progress-bar-attendence progress-bar-success green-sharp">
                            <span class="sr-only">0% progress</span>
                        </span>
					      <div class="subgrid1">Average Hours - <span class="maxspan">9</span></div>
                           <div class="subgrid2">Min-<span class="maxspan"><%=request.getAttribute("hmin")%>%</span></div>
				</div>
		     </div>
				        <div class="col-md-4">
					        <div id="col">
							    <div class="leaves1">Leaves </div>
                                     <div class="leaves2">Max-<span class="maxspan"><%=request.getAttribute("lmax") %></span></div>
									 <span style="width: 100%;" class="progress-bar-leaves progress-bar-success green-sharp">
                            <span class="sr-only">0% progress</span>
                        </span>
                                          <div class="leaves3">Average Leaves - <span class="maxspan">2</span></div>
                                                   <div class="leaves4">Min-<span class="maxspan"><%=request.getAttribute("lmin") %></span></div>
			                </div>
							</div>
							
					<div class="col-md-4">
						<div id="col">
						<div class="leaves1">Employees</div></br>
						<span style="width: 100%;" class="progress-bar-employees progress-bar-success green-sharp">
                            <span class="sr-only">0% progress</span>
                        </span> </br>
						        
								 <div class="emp2">Total Employees<span class="pull-right emp-rep"><%=request.getAttribute("empcount") %></span></div>
								  <div class="emp3">Extra Leaves Taken<span class="pull-right emp-rep"><%=request.getAttribute("eleave") %></span></div>
								 <div class="emp4">Total Absentees<span class="pull-right emp-rep"><%=request.getAttribute("absent") %></span></div>
								 <div class="emp5">Below 9Hour<span class="pull-right emp-rep"><%=request.getAttribute("below9hr") %></span></div>
