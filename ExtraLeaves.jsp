...
<fieldset style="min-height: 490px;">
		<legend>Report On Leaves</legend>
<form class="form-horizontal" role="form" method="get" action="ExtraLeavesServlet" >
  ...
  <h4 align="left">Month & Year : <%=request.getAttribute("fdate") %></h4>
  ...
  <tr style="background-color:silver";>
		...
		<th><font color='Red'>Date of Leave from</font></th>
		<th><font color='Red'>Date of Leave to</font></th>
      </tr>
    </thead>
...
<td><%out.println(exleave1.getAveg());%></td>
   ...
   <div style="text-align:center;">
				<button formaction="ExtraLeavePDFServlet" class="btn btn-danger" ><span class="fa fa-file-pdf-o" ></span>  PDF</button>
