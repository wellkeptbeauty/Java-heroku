...
<form method="get" action="ProfileUpdateServlet" >
		<div class="col-md-9">
		...
		<legend>Profile InFormation</legend>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("fname")%>" name="fname" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("lname")%>" name="lname" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("mailid")%>" name="mailid" readonly="readonly" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("mobile")%>" name="mobile" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
	<input type="text" class="form-control" value="<%=request.getAttribute("dob")%>" name="dob" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("address")%>" name="address" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("city")%>" name="city" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("state")%>" name="state" />
					</div>
				</div>
				</div>
				<div style="font-size:16px;padding:15px 0px">
				<div class="form-group">
					<div class="col-md-3">
						ZipCode <span class="pull-right">:</span>
					</div>
					<div class="col-md-6">
						<input type="text" class="form-control" value="<%=request.getAttribute("zip")%>" name="zip" />
					</div>
				</div>
				</div>
				<div class="form-group">
