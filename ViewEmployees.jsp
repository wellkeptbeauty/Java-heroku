...
<div class="table-responsive">
  ...
  <th><font color='Red'>EMAIL</font></th></tr></thead>
  
 <%
Class.forName("oracle.jdbc.driver.OracleDriver");
Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","viru","prasad");
Statement stmt=con.createStatement();
ResultSet rs=stmt.executeQuery("select eid,ename,eaddress,edesg,edoj,ephone,eemail from regemp order by eid");
  while(rs.next())
  {
      String EmployeeId=rs.getString("eid");
      String EmployeeName=rs.getString("ename");
      String EmpAddress=rs.getString("eaddress");
      String EmpDesignation=rs.getString("edesg");
      String DOJ=rs.getString("edoj");
      long Empphone=rs.getLong("ephone");
...
<div style="text-align:center;">
   ...
   <input type="button" class="btn btn-success" onclick="location.href='http://localhost:8081/BetaBulls/HomePage.jsp';" value="OK"> </button>
   </div>
   </fieldset>
   </div>
      </div>
