...
<% EmployeePojo below9hr = new EmployeePojo(); %>

<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<html>
<head>
<title>Report On Below 9 Hours </title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
   ...
   <link rel="stylesheet" type="text/css" href="resources/css/custom.css">
    <script src="resources/javascript/ReportOnBelow9hrs.js"></script>
...
<fieldset style="min-height: 490px;">
		<legend>Report On Below 9 Hours</legend>
<form  method="get" action="Below9hrsServlet">
...
<div style="text-align:center;">
				...
				<button type="submit" class="btn btn-danger" formaction="Below9hrPDF" ><span class="fa fa-file-pdf-o" ></span> PDF</button>
				</div>
	 </fieldset>
   </div>
   </div>
